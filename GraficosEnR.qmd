...
do_respuesta <- function(respuesta) {
  if(respuesta == "geom_line() y geom_bar()") {
    return("Buen trabajo!, geom_line() es para gráficos de líneas y geom_bar() es para gráficos de barras.")
  } else {
    return("Vuelve a intentar, En general a la palabra geom_ se le agrega el nombre de la geometría en Inglés")
  }
}
```
